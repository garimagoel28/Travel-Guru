export const NAV_LINKS = [
    ...
    { href: "/", key: "how_Travel Guru_work", label: "How Travel Guru Works?" },
...
export const FEATURES = [
    ...
    },
    {
        ...
        icon: "/calendar.svg",
        variant: "green",
        description: "Schedule an adventure with friends. On holidays, there are many interesting offers from Travel Guru. That way, there's no more discussion",
    },
    {
...
export const FOOTER_CONTACT_INFO = {
    ...
    links: [
        ...
        { label: "Email", value: "TravelGuru@fmail.com" },
    ],
};
